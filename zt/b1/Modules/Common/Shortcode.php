        ...
        if($role['cap'] === 'roles' && $role['allow'] === false){
            ...
            return '<div class="content-cap content-see-lv">
                <div>
                    ...
                    '.(!$user_id ?
                        self::login_button('a href="javascript:void(0)"')
                        : '<div class="content-cap-title"><a href="'.b2_get_custom_page_url('vips').'" target="_blank" class="button mp-hidden" data-link="/my/vips">'.__('立刻升级','b2').'</a><a href="javascript:void(0)" class="button mp-show" data-link="/my/vips">'.__('立刻升级','b2').'</a></div>').'
