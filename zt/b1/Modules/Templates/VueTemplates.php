    ...
    public static function scripts_init(){
        ...
        wp_localize_script( 'vue', 'b2_global',apply_filters('b2_global_settings',array(
            ...
            'chat'=>array(
                ...
                'weixin'=>b2_get_option('template_aside','aside_chat_weixin')
            ),
            'default_thumb'=>B2_THEME_URI.'/Assets/fontend/images/default-img.jpg',
            'post_type'=>$single ? Comment::get_post_type($post_id) : '',
            'money_symbol'=>B2_MONEY_SYMBOL,
            'credit_symbol'=>b2_get_icon('b2-coin-line'),
        )));
    }
