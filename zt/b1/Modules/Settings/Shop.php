...
class Shop{
    ...
    public static function get_default_settings($key){
        $arr = array(
            'shop_cat'=>array(),
            'shop_cat_buy_title'=>__('商品购买','b2'),
            'shop_cat_exchange_title'=>__('积分兑换','b2'),
            'shop_cat_lottery_title'=>__('积分抽奖','b2'),
        );
    ...
    public function shop_settings(){
        ...
        $shop->add_field(
            array(
                ...
                'before_row'=>'<h2>'.sprintf(__('%s首页幻灯设置'),$shop_name).'</h2>'
            )
        );
        ...
        $shop->add_field(array(
            ...
            'before_row'=>'<h2>'.sprintf(__('%s首页分类导航设置','b2'),$shop_name).'</h2>'
        ));
        ...
        $shop->add_field(array(
            ...
            'before_row'=>'<h2>'.sprintf(__('%s首页商品设置','b2'),$shop_name).'</h2>'
        ));
        ...
        $shop->add_field(array(
            'name'    => __( '每行显示多少个商品', 'b2' ),
            'id'=>'shop_type_count_row',
            'type'=>'text',
            'default'=>self::$default_settings['shop_type_count_row'],
        ));

        $shop->add_field(array(
            'name'    => sprintf(__( '%s首页商品购买标题', 'b2' ),$shop_name),
            'id'=>'shop_cat_buy_title',
            'type'=>'text',
            'default'=>self::get_default_settings('shop_cat_buy_title')
        ));

        $shop->add_field(array(
            'name'    => sprintf(__( '%s首页积分兑换标题', 'b2' ),$shop_name),
            'id'=>'shop_cat_exchange_title',
            'type'=>'text',
            'default'=>self::get_default_settings('shop_cat_exchange_title')
        ));

        $shop->add_field(array(
            'name'    => sprintf(__( '%s首页积分抽奖标题', 'b2' ),$shop_name),
            'id'=>'shop_cat_lottery_title',
            'type'=>'text',
            'default'=>self::get_default_settings('shop_cat_lottery_title')
        ));
