...
class User{
    ...
    public static function check_user_write_role(){
        ...
        $setting_lvs = array();
        $setting_lvs['all'] = __('所有用户','b2');
        $setting_lvs['lv'] = __('所有普通用户','b2');
        $setting_lvs['vip'] = __('所有付费会员','b2');
        ...
        $roles = [];
        $roles['free'] = __('免费下载','b2');
        $roles['money'] = __('付费下载','b2');
        $roles['credit'] = __('积分下载','b2');
        $roles['comment'] = __('评论下载','b2');
        $roles['login'] = __('登录下载','b2');
